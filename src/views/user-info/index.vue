      ...
      <div class="user-info-box" id="userInfoBox">
        ...
        <div class="header">
          <el-descriptions :column="2" border>
            ...
            >{{$filters.dateFilter(detailData.openTime)}}</el-descriptions-item>
        ...
        <div class="body">
          <el-descriptions direction="vertical" :column="1" border>
            ...
            <el-descriptions-item :label="$t('msg.userInfo.major')">{{ detailData.major }}</el-descriptions-item>
            <el-descriptions-item :label="$t('msg.userInfo.glory')">{{ detailData.glory }}</el-descriptions-item>
          </el-descriptions>
        </div>
